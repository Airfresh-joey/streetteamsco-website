...
export default function BookPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', color: '#fff' }}>
      ...
      {/* Powered by Air Fresh Marketing */}
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', background: '#060d1a', padding: '20px 24px', textAlign: 'center' }}>
        <a href="https://airfreshmarketing.com" target="_blank" rel="noopener noreferrer"
          ...
          <span style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '2px', textTransform: 'uppercase', color: 'rgba(255,255,255,0.45)' }}>Powered by</span>
