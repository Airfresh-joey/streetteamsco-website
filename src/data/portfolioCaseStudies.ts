...
export const portfolioCaseStudies: CaseStudy[] = [
  // ============ FEATURED CASE STUDIES ============
  {
    ...
    services: ["Guerrilla Street Marketing", "Coupon Distribution", "Food Sampling", "Sidewalk Activations"],
  ...
  },
  {
    ...
    services: ["Guerrilla Street Marketing", "Costume Activations", "Flyering", "Street Performance"],
    markets: ["Dallas"],
    date: "October 2024",
  ...
  },
  {
    ...
    industry: "Food & Beverage",
    services: ["Urban Brand Ambassadors", "Guerrilla Flyering", "QR Code Activations", "Street Team Promotion"],
  ...
  },
  {
    ...
    industry: "Food & Beverage",
    services: ["Street Sampling", "Guerrilla Product Distribution", "Urban Brand Ambassadors"],
    markets: ["New York City"],
    date: "March 2025",
  ...
  // ============ TECHNOLOGY & MEDIA ============
  {
    ...
    industry: "Technology",
    services: ["Event Staffing", "Guest Experience", "Meeting Check-In", "Wayfinding"],
    markets: ["New York City"],
    date: "January 2020",
  ...
  // ============ ENTERTAINMENT ============
  {
    ...
    services: ["Street Team Deployment", "Guerrilla Brand Activation", "Merchandise Distribution"],
    markets: ["Las Vegas"],
    date: "November 2024",
  ...
  },
  {
    ...
    industry: "Sports & Entertainment",
    services: ["Street Team Deployment", "Fan Engagement", "Branded Giveaways"],
  ...
  },
  {
    ...
    industry: "Food & Beverage",
    services: ["Street Sampling", "Guerrilla Marketing", "Crowd Activation"],
  ...
  },
  {
    ...
    services: ["Brand Activation", "Event Staffing", "Experiential Support"],
  ...
  },
  {
    ...
    services: ["Street Team Marketing", "Pop-Up Activations", "Urban Sports Engagement", "Guerrilla Product Demos"],
    markets: ["Nationwide"],
    date: "2024",
    stats: {
  ...
  },
  {
    ...
    services: ["Guerrilla Street Marketing", "Campus Activations", "Pop-Up Sign-Up Stations", "Street Teams"],
    markets: ["Nationwide"],
    date: "2024",
    stats: {
      "Cities Activated": "75+",
  ...
  // ============ NEW STREET-TEAM-SPECIFIC CASE STUDIES ============
  {
    id: "guerrilla-nyc-campaign",
    name: "Guerrilla Marketing Takeover - NYC",
    tagline: "Own the Streets of Manhattan",
    description: "Street Teams Co designed and executed a full-scale guerrilla marketing campaign across Manhattan for a major DTC brand launch. Tactics included sidewalk chalk art installations, costumed brand characters at Times Square and Union Square, wild posting across construction sites, and roving sample squads on bikes. The campaign generated over 2 million organic social impressions and drove a 340% spike in website traffic during the activation week.",
    industry: "Consumer Products",
    services: ["Guerrilla Marketing", "Wild Posting", "Sidewalk Chalk Art", "Costumed Characters", "Bike Sampling Squads"],
    markets: ["New York City"],
    date: "September 2024",
    stats: {
      "Social Impressions": "2M+",
      "Website Traffic Spike": "+340%",
      "Samples Distributed": "30,000+",
      "Wild Postings": "500+ Locations"
    },
    category: "Technology",
    featured: false,
    heroImage: "https://images.unsplash.com/photo-1533750516457-a7f992034fec?q=80&w=2006&auto=format&fit=crop"
  },
  {
    id: "led-truck-vegas-strip",
    name: "LED Truck Campaign - Vegas Strip Domination",
    tagline: "Mobile Billboards That Stop Traffic",
    description: "Street Teams Co orchestrated a high-impact LED truck advertising campaign rolling through the Las Vegas Strip and Los Angeles entertainment districts. Our mobile billboards featured dynamic video content, geo-targeted messaging, and real-time social media integration. The trucks were strategically routed past nightclubs, convention centers, and event venues during peak hours, creating an impossible-to-ignore brand presence.",
    industry: "Advertising",
    services: ["LED Truck Advertising", "Mobile Billboards", "Route Strategy", "Dynamic Content"],
    markets: ["Las Vegas", "Los Angeles"],
    date: "2024",
    stats: {
      "Impressions": "3.2M+",
      "Brand Recall": "+27%",
    ...
    category: "Technology",
    featured: false,
    heroImage: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?q=80&w=2032&auto=format&fit=crop"
  },
  {
    id: "festival-street-teams",
    name: "Festival Street Team - Coachella & Beyond",
    tagline: "Own the Festival Grounds",
    description: "Street Teams Co deployed guerrilla street teams outside major music festivals including Coachella, Lollapalooza, and Rolling Loud. Our ambassadors worked the surrounding streets, parking lots, campgrounds, and hotel zones — distributing samples, branded merchandise, and exclusive promo codes to festival-goers before they even entered the gates. This outside-the-venue strategy captured audiences traditional sponsorships miss.",
    industry: "Entertainment",
    services: ["Festival Street Teams", "Guerrilla Sampling", "Perimeter Marketing", "Brand Ambassador Deployment"],
    markets: ["Indio, CA", "Chicago", "Miami"],
    date: "2023-2024",
    stats: {
      "Festivals Covered": "8 Major Events",
      "Samples Given": "100,000+",
      "Brand Interactions": "45,000+",
      "Promo Code Redemptions": "8,500+"
    },
    category: "Entertainment",
    featured: false,
  ...
  {
    id: "product-launch-street-activation",
    name: "Product Launch Street Activation - Energy Drink",
    tagline: "Launch Day on Every Corner",
    description: "When a new energy drink brand needed to make a splash on launch day, Street Teams Co mobilized 50+ brand ambassadors across five cities simultaneously. Our teams set up pop-up sampling stations at gyms, college campuses, office parks, and transit hubs — putting the product directly in the hands of the target demographic. The coordinated multi-city street blitz generated immediate trial and word-of-mouth that traditional advertising can't replicate.",
    industry: "Beverage",
    services: ["Product Launch Activation", "Multi-City Street Teams", "Pop-Up Sampling", "Campus Marketing"],
    markets: ["New York City", "Los Angeles", "Chicago", "Miami", "Atlanta"],
    date: "January 2025",
    stats: {
      "Cities Activated": "5 Simultaneously",
      "Ambassadors Deployed": "50+",
      "Samples Distributed": "75,000+",
      "Social Posts Generated": "3,200+"
    },
    category: "Food & Beverage",
    featured: false,
  ...
  {
    id: "urban-ambassador-program",
    name: "Urban Brand Ambassador Program - Fashion District",
    tagline: "Street Style Meets Street Marketing",
    description: "Street Teams Co created an ongoing urban brand ambassador program for a streetwear brand, deploying fashion-forward ambassadors in LA's Fashion District, NYC's SoHo, and Miami's Wynwood. Our team didn't just hand out flyers — they became walking billboards wearing the brand, creating authentic street-level engagement and Instagram-worthy moments that drove organic social growth and foot traffic to pop-up shops.",
    industry: "Fashion & Streetwear",
    services: ["Urban Brand Ambassadors", "Lifestyle Marketing", "Pop-Up Shop Promotion", "Social Media Activation"],
    markets: ["Los Angeles", "New York City", "Miami"],
    date: "2024 - Ongoing",
    stats: {
      "Ambassador Team": "30+ Ongoing",
      "Monthly Interactions": "20,000+",
      "Instagram Growth": "+45K Followers",
      "Pop-Up Traffic": "+280%"
    },
    category: "Beauty & Fashion",
    featured: false,
  ...
  {
    id: "street-sampling-health-wellness",
    name: "Street Sampling Blitz - Health & Wellness Tour",
    tagline: "Healthy Living, Delivered on the Street",
    description: "Street Teams Co executed a 12-city street sampling tour for a health and wellness brand, targeting fitness enthusiasts outside gyms, yoga studios, running paths, and farmer's markets. Our brand ambassadors distributed product samples alongside branded workout towels and discount cards, creating meaningful touchpoints with health-conscious consumers in their natural environment — no expensive venue rental required.",
    industry: "Health & Wellness",
    services: ["Street Sampling Tour", "Fitness Community Targeting", "Guerrilla Product Distribution", "Brand Ambassador Teams"],
    markets: ["12 Major US Cities"],
    date: "March-June 2024",
    stats: {
      "Cities Covered": "12",
      "Samples Distributed": "200,000+",
      "Gym Partnerships": "150+",
      "Purchase Conversion": "+18%"
    },
    category: "Food & Beverage",
    featured: false,
    heroImage: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=2069&auto=format&fit=crop"
  }
];
