...
const pillarPages = [
  ...
  'sema-event-staffing',
  'sxsw-event-staffing',
  'dreamforce-event-staffing',
  'mercedes-benz-stadium-event-staffing',
  'att-stadium-event-staffing',
  'hard-rock-stadium-event-staffing',
  'nrg-stadium-event-staffing',
  'lincoln-financial-field-event-staffing',
  'levis-stadium-event-staffing',
  'lumen-field-event-staffing',
  'arrowhead-stadium-event-staffing',
  'gillette-stadium-event-staffing',
  'crypto-com-arena-event-staffing',
  'sphere-las-vegas-event-staffing',
  'intuit-dome-event-staffing',
  'kia-forum-event-staffing',
  'bmo-stadium-event-staffing',
  'madison-square-garden-event-staffing',
  'allegiant-stadium-event-staffing',
  'united-center-event-staffing',
  'caesars-superdome-event-staffing',
  'soldier-field-event-staffing',
  't-mobile-arena-event-staffing',
  'state-farm-stadium-event-staffing',
  'las-vegas-convention-center-event-staffing',
  'mccormick-place-event-staffing',
  'orange-county-convention-center-event-staffing',
  'javits-center-event-staffing',
  'georgia-world-congress-center-event-staffing',
  'moscone-center-event-staffing',
  'anaheim-convention-center-event-staffing',
  'walter-e-washington-convention-center-event-staffing',
  'kay-bailey-hutchison-convention-center-event-staffing',
  'boston-convention-exhibition-center-event-staffing',
  'music-city-center-event-staffing',
  'colorado-convention-center-event-staffing',
  'chase-center-event-staffing',
  'barclays-center-event-staffing',
  'td-garden-event-staffing',
  'dodger-stadium-event-staffing',
  'yankee-stadium-event-staffing',
  'fenway-park-event-staffing',
  'wrigley-field-event-staffing',
  'oracle-park-event-staffing',
  'ball-arena-event-staffing',
  'american-airlines-center-event-staffing',
  'kaseya-center-event-staffing',
  'capital-one-arena-event-staffing',
  'wells-fargo-center-event-staffing',
  'footprint-center-event-staffing',
  'toyota-center-event-staffing',
  'little-caesars-arena-event-staffing',
  'golden-1-center-event-staffing',
  'spectrum-center-event-staffing',
  'fiserv-forum-event-staffing',
  'paycom-center-event-staffing',
  'indianapolis-motor-speedway-event-staffing',
  'daytona-international-speedway-event-staffing',
  'circuit-of-the-americas-event-staffing',
  'red-rocks-amphitheatre-event-staffing',
  'hollywood-bowl-event-staffing',
  'lambeau-field-event-staffing',
  'lucas-oil-stadium-event-staffing',
  'us-bank-stadium-event-staffing',
  'empower-field-at-mile-high-event-staffing',
  'bank-of-america-stadium-event-staffing',
  'san-diego-convention-center-event-staffing',
  'acrisure-stadium-event-staffing',
  'highmark-stadium-event-staffing',
  'raymond-james-stadium-event-staffing',
  'nissan-stadium-event-staffing',
  'ford-field-event-staffing',
  'm-t-bank-stadium-event-staffing',
  'citi-field-event-staffing',
  'truist-park-event-staffing',
  'petco-park-event-staffing',
  'citizens-bank-park-event-staffing',
  'coors-field-event-staffing',
  'busch-stadium-event-staffing',
  'globe-life-field-event-staffing',
  'minute-maid-park-event-staffing',
  'target-field-event-staffing',
  'pnc-park-event-staffing',
  'pennsylvania-convention-center-event-staffing',
  'ernest-morial-convention-center-event-staffing',
...
addUrl('/field-marketing-statistics', 0.8, 'monthly');
addUrl('/sports-stadium-marketing-statistics', 0.8, 'monthly');
addUrl('/major-event-staffing', 0.9, 'weekly');
