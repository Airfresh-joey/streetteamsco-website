...
${faqSchemaEntries}
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* ==================== URGENCY BANNER ==================== */
    .urgency-banner { background: linear-gradient(90deg, #FF4D00, #E04300); color: #0f172a; padding: 0.85rem 2rem; text-align: center; font-weight: 700; font-size: 0.95rem; letter-spacing: 0.2px; }
    ...
    .stat-box { background: #0f172a; color: #fff; padding: 1.5rem 1rem; border-radius: 14px; text-align: center; border: 1px solid rgba(255,77,0,0.15); box-shadow: 0 8px 32px rgba(0,0,0,0.2); }
    .stat-box .number { font-size: 1.75rem; font-weight: 900; color: #FF4D00; letter-spacing: -0.5px; }
    ...
    /* ==================== SECTION DIVIDER ==================== */
    .section-divider { height: 3px; background: linear-gradient(90deg, transparent, #FF4D00, #0d9488, transparent); margin: 3rem 0; border: none; border-radius: 2px; }
    ...
    .service-card::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, #FF4D00, #0d9488); }
    .service-card:hover { border-color: #FF4D00; transform: translateY(-3px); box-shadow: 0 12px 32px rgba(0,0,0,0.08); }
    .service-card .card-icon { font-size: 1.5rem; color: #FF4D00; margin-bottom: 0.75rem; }
    ...
    .service-card a { color: #E04300; font-weight: 600; font-size: 0.9rem; }

    .dark-section .service-card { background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1); }
    .dark-section .service-card:hover { border-color: #FF4D00; background: rgba(255,255,255,0.08); }
    ...
    .pricing-table tbody tr:hover { background: #FFF3EE; }
    ...
    .cta-section::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 4px; background: linear-gradient(90deg, #FF4D00, #0d9488); }
    ...
    .cta-btn { display: inline-block; background: #FF4D00; color: #0f172a; padding: 1rem 2.5rem; border-radius: 10px; text-decoration: none; font-weight: 800; font-size: 1.05rem; transition: all 0.25s ease; letter-spacing: 0.3px; box-shadow: 0 4px 16px rgba(255,77,0,0.3); }
    .cta-btn:hover { background: #fbbf24; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(255,77,0,0.4); text-decoration: none; }
    ...
    .cta-secondary:hover { border-color: #FF4D00; color: #FF4D00; text-decoration: none; }
    ...
    .festival-highlight { background: linear-gradient(135deg, rgba(255,77,0,0.08), rgba(13,148,136,0.08)); border: 2px solid rgba(255,77,0,0.2); border-radius: 16px; padding: 2rem 2.25rem; margin: 2rem 0; }
    ...
    .city-link-card { background: #fff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 1.25rem 1.5rem; border-left: 4px solid #FF4D00; transition: all 0.2s; }
    ...
    .city-link-card .venue-name { font-size: 0.82rem; color: #FF4D00; font-weight: 700; margin-bottom: 0.35rem; }
...
<div class="dark-section">
  <div class="section-inner">
    ...
    <div class="festival-highlight" style="background: rgba(255,255,255,0.05); border-color: rgba(255,77,0,0.3);">
      ...
      <div class="fest-meta">
        <div class="fest-meta-item">
          <div>
            ...
            <div class="meta-value" style="color: #FF4D00;">${city.fanFestival}</div>
          </div>
        </div>
        <div class="fest-meta-item">
          <div>
            <div class="meta-label" style="color: rgba(255,255,255,0.5);">Capacity</div>
            <div class="meta-value" style="color: #FF4D00;">${city.fanFestivalCapacity}</div>
          </div>
        </div>
        <div class="fest-meta-item">
          <div>
            <div class="meta-label" style="color: rgba(255,255,255,0.5);">Dates</div>
            <div class="meta-value" style="color: #FF4D00;">${city.fanFestivalDates}</div>
          </div>
        </div>
      </div>
    ...
    <ul style="color: rgba(255,255,255,0.85);">
      <li><strong style="color: #FF4D00;">Product sampling stations</strong> -- Distribute beverages, snacks, and promotional items to thousands of engaged fans daily at ${city.fanFestival}</li>
      <li><strong style="color: #FF4D00;">Brand experience zones</strong> -- Create immersive, interactive brand experiences with trained ambassadors guiding consumers through multi-touch activations</li>
      <li><strong style="color: #FF4D00;">Sponsor activation support</strong> -- Staff official sponsor activations with bilingual, brand-trained personnel who represent your messaging with authenticity</li>
      <li><strong style="color: #FF4D00;">Roaming street teams</strong> -- Deploy mobile engagement crews throughout the festival grounds and surrounding areas for maximum coverage</li>
      <li><strong style="color: #FF4D00;">Social media content creation</strong> -- Staff trained to capture and encourage user-generated content, manage branded hashtags, and drive social amplification</li>
      <li><strong style="color: #FF4D00;">VIP and hospitality services</strong> -- Premium service staff for corporate areas, sponsor lounges, and exclusive fan experiences</li>
    </ul>
  </div>
</div>
