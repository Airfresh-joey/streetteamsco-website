...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    a { color: inherit; }
    /* Header */
    .site-header { position: sticky; top: 0; z-index: 100; background: #0b1220; border-bottom: 1px solid rgba(255,255,255,0.08); }
    .header-inner { max-width: 1280px; margin: 0 auto; padding: 16px 32px; display: flex; align-items: center; justify-content: space-between; gap: 16px; }
    .site-logo { font-weight: 800; font-size: 1.25rem; letter-spacing: 0.02em; text-transform: uppercase; color: #fff; text-decoration: none; white-space: nowrap; }
    .header-nav { display: flex; align-items: center; gap: 24px; flex-wrap: wrap; }
    .header-nav a { font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.06em; color: rgba(255,255,255,0.75); text-decoration: none; }
    .header-nav a:hover { color: #ff6b35; }
    .header-nav .phone { font-weight: 700; color: #fff; }
    .header-nav .cta { background: #ff6b35; color: #0b1220; padding: 10px 20px; font-weight: 700; border-radius: 8px; }
    .header-nav .cta:hover { color: #0b1220; opacity: 0.9; }
    @media (max-width: 860px) { .header-nav a:not(.cta):not(.phone) { display: none; } }
    /* Hero */
    ...
    /* Footer */
    .site-footer { background: #0b1220; border-top: 1px solid rgba(255,255,255,0.08); padding: 56px 24px 32px; }
    .footer-inner { max-width: 1280px; margin: 0 auto; }
    .footer-grid { display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 40px; }
    @media (max-width: 760px) { .footer-grid { grid-template-columns: 1fr; gap: 28px; } }
    .footer-grid h3 { font-size: 0.95rem; font-weight: 800; margin: 0 0 14px; color: #fff; }
    .footer-grid a { display: block; color: rgba(255,255,255,0.6); text-decoration: none; font-size: 0.9rem; margin-bottom: 8px; }
    .footer-grid a:hover { color: #ff6b35; }
    .footer-brand p { color: rgba(255,255,255,0.55); font-size: 0.9rem; max-width: 360px; line-height: 1.6; }
    .footer-bottom { border-top: 1px solid rgba(255,255,255,0.08); margin-top: 40px; padding-top: 24px; display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 16px; }
    .footer-bottom p { color: rgba(255,255,255,0.4); font-size: 0.82rem; margin: 0; }
    .footer-afm a { display: inline-flex; align-items: center; gap: 10px; text-decoration: none; }
    .footer-afm span { font-size: 10px; font-weight: 600; letter-spacing: 2px; text-transform: uppercase; color: rgba(255,255,255,0.35); }
  </style>
</head>
<body>
  <header class="site-header">
    <div class="header-inner">
      <a href="/" class="site-logo">Street Teams Co</a>
      <nav class="header-nav">
        <a href="/services">Services</a>
        <a href="/portfolio">Portfolio</a>
        <a href="/locations">Locations</a>
        <a href="/blog/">Blog</a>
        <a href="tel:3037206060" class="phone">(303) 720-6060</a>
    ...
    <div class="footer-inner">
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p><a href="tel:3037206060" style="color:#ff6b35;font-weight:700;">(303) 720-6060</a> &middot; 1580 N Logan St Suite 660, Denver, CO 80203</p>
        </div>
        <div>
          <h3>Services</h3>
          <a href="/services/street-teams">Street Teams</a>
          <a href="/services/brand-ambassadors">Brand Ambassadors</a>
          <a href="/services/event-staffing">Event Staffing</a>
      ...
      <div class="footer-bottom">
        ...
        <div class="footer-afm">
          <a href="https://airfreshmarketing.com" target="_blank" rel="noopener noreferrer">
            <span>Powered by</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 453.27 124.49" style="height:20px;width:auto" aria-label="Air Fresh Marketing"><path fill="rgba(255,255,255,0.55)" d="M170.35,32.1h14L206.74,85H191.13l-3.82-9.38H167.05L163.3,85H148Zm12.76,32.19-5.85-14.93-5.93,14.93Z"/><path fill="rgba(255,255,255,0.55)" d="M208.1,30.23H223v10.5H208.1Zm.29,14.18h14.26V85H208.39Z"/><path fill="rgba(255,255,255,0.55)" d="M227.75,44.41H242v8.18c2.33-5.55,6.08-9.16,12.83-8.86v15h-1.2C246.2,58.74,242,63,242,72.4V85H227.75Z"/><path fill="rgba(255,255,255,0.55)" d="M258.29,32.48h42V45.23H272.84v8.94h24.83V66.25H272.84V85H258.29Z"/><path fill="rgba(255,255,255,0.55)" d="M303.83,44.41h14.25v8.18c2.32-5.55,6.07-9.16,12.83-8.86v15h-1.2c-7.43,0-11.63,4.28-11.63,13.66V85H303.83Z"/><path fill="rgba(255,255,255,0.55)" d="M332.64,64.89v-.15c0-11.85,8.47-21.23,20.47-21.23,14,0,20.48,10.28,20.48,22.21,0,.9,0,2-.07,2.93H346.36c1.13,4.42,4.35,6.67,8.78,6.67,3.38,0,6.08-1.27,9-4.12L372,77.73c-3.9,5-9.53,8.25-17.63,8.25C341.64,86,332.64,77.5,332.64,64.89Zm27.6-3.52c-.52-4.5-3.15-7.36-7.05-7.36s-6.3,2.93-7.05,7.36Z"/><path fill="rgba(255,255,255,0.55)" d="M374.65,79.9,380,71.27a26.34,26.34,0,0,0,13.95,4.66c2.47,0,3.6-.75,3.6-2.18V73.6c0-1.58-2.25-2.25-6.53-3.45-8-2.1-14.4-4.8-14.4-13V57c0-8.63,6.9-13.44,16.28-13.44a31.77,31.77,0,0,1,16.73,4.73l-4.88,9c-4.2-2.33-8.78-3.76-12-3.76-2.18,0-3.3.83-3.3,2v.14c0,1.58,2.32,2.33,6.6,3.61,8,2.25,14.4,5,14.4,12.9v.15c0,8.93-6.67,13.59-16.58,13.59A32.76,32.76,0,0,1,374.65,79.9Z"/><path fill="rgba(255,255,255,0.55)" d="M413.06,30.23h14.25V50c2.63-3.37,6.38-6.45,12.16-6.45,8.62,0,13.8,5.7,13.8,14.93V85H439V63c0-4.43-2.33-6.83-5.7-6.83s-6,2.4-6,6.83V85H413.06Z"/><path fill="rgba(255,255,255,0.55)" d="M62.25,0a62.25,62.25,0,1,0,62.24,62.25A62.31,62.31,0,0,0,62.25,0Zm0,109.51a47.27,47.27,0,1,1,47.26-47.26A47.32,47.32,0,0,1,62.25,109.51Z"/><polygon fill="rgba(255,255,255,0.55)" points="54.36 32.05 75.56 85.08 91.29 85.08 70.09 32.05 54.36 32.05"/><polygon fill="rgba(255,255,255,0.55)" points="33.21 85.08 48.94 85.08 58.73 60.59 42.99 60.59 33.21 85.08"/></svg>
          </a>
        </div>
      </div>
    </div>
